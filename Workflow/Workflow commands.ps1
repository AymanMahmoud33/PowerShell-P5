...
# you can use default parameter as follows
Get-SystemStuff -PSComputerName DC1
...
Copy-Files \\Server1\ps\installs c:\installs
...
Copy-FilesCheck \\Server1\ps\installs c:\installs -AsJob
Stop-Computer Server1 -Force
