...
{ 
    ...
    Import-DSCResource -ModuleName xInternetExplorerHomePage # install the module of not present
...
SetIEHomePage -StartPageURL "www.google.com" -SecondaryStartPagesURL "www.bing.com"
...
$destination = "\\dc1\c`$\program files\windowspowershell\dscservice\configuration\$guid.mof"
...
$destination = "\\dc1\c`$\program files\windowspowershell\dscservice\modules\xInternetExplorerHomePage_1.0.0.0.zip"
